...
export default {
  ...
  head: {
    ...
    script: [
      { hid: 'jquery', src: '/slots/js/jquery-3.2.1.min.js' },
      { hid: 'createjs', src: '/slots/js/createjs-2015.11.26.min.js' },
      { hid: 'howler', src: '/slots/js/howler.min.js' },
      { hid: 'main', src: '/slots/js/main.js' },
    ],
  },
    ...
    setTimeout(() => {
      $(document).ready(function () {
        var oMain = new CMain({
          ...
          time_show_win: 1500, //DURATION IN MILLISECONDS OF THE WINNING COMBO SHOWING
          time_show_all_wins: 1500, //DURATION IN MILLISECONDS OF ALL WINNING COMBO
          ...
          paytable_symbol_1: [0, 50, 100, 150, 200], //PAYTABLE FOR SYMBOL 1
          paytable_symbol_2: [0, 30, 50, 100, 150], //PAYTABLE FOR SYMBOL 2
          paytable_symbol_3: [0, 20, 25, 50, 100], //PAYTABLE FOR SYMBOL 3
        ...
        $(oMain).on('save_score', function (evt, iMoney) {
          ...
          //...ADD YOUR CODE HERE EVENTUALLY
          console.log('save score here', iMoney)
        })
