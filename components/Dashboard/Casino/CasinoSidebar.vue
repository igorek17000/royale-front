<template>
  ...
  >
    ...
    <div class="space-y-4 mt-3 game-list">
      <!-- <game-list /> -->
      <nuxt-link
        ...
        class="
          ...
          shadow-lg
          relative
          hover:ring-2 hover:ring-custom-red
          focus:outline-none
        "
        :to="localePath({ name: `${game.url}` })"
      >
        <div
          class="
            flex flex-col
        ...
        >
          <div class="h-32 w-full mb-3">
            <img
              v-if="game.image.formats.small.url"
              :src="baseURL + game.image.formats.small.url"
...
<style scoped>
.game-list > .nuxt-link-exact-active {
  border: 1px solid #d91139;
}
</style>