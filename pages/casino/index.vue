    ...
    <div class="flex-grow overflow-hidden h-full flex flex-col">
      ...
      >
        <div class="flex h-full text-gray-600 dark:text-gray-400">
          ...
          <a
            href="#"
            class="cursor-pointer h-full border-b-2 border-blue-500 text-blue-500 dark:text-custom-red dark:border-custom-red inline-flex mr-8 items-center"
            >Users</a
          >
          <a
            href="#"
      ...
      <div class="flex-grow flex overflow-x-hidden">
          ...
          <div class="space-y-4 mt-3">
            ...
            >
              ...
              <div class="flex items-center w-full">
                <div
                  class="text-xs py-1 px-2 leading-none dark:bg-primary bg-blue-100 text-blue-500 rounded-md"
                >
                  Design
                </div>
            ...
            >
              ...
              <div class="flex items-center w-full">
                <div
                  class="text-xs py-1 px-2 leading-none dark:bg-primary bg-yellow-100 text-yellow-600 rounded-md"
                >
                  Marketing
                </div>
        ...
        <div class="flex-grow bg-white dark:bg-primary overflow-y-auto">
          <div
