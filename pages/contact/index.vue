<template>
  <div class="text-gray-100 px-8 py-10">
    <div
      class="
        max-w-screen-xl
        mt-24
    ...
    >
      <div class="flex flex-col justify-between">
        <div>
          <h2 class="text-4xl lg:text-2xl font-bold leading-tight">
            Send an message about your deposit
          </h2>
        </div>
      ...
      <form @submit.prevent="submitForm">
        <div class="mt-8">
          <span class="uppercase text-sm text-gray-300 font-bold">Message</span>
          <textarea
            class="
              w-full
              h-32
    ...
    async submitForm() {
      ...
      await this.$axios
        .post('/mails/new', {
          ...
          subject: 'Contact form | Login',
          html: `Name: ${this.$auth.user.name} , <br>
                 Phone Number: ${this.$auth.user.phone_number} , <br>
